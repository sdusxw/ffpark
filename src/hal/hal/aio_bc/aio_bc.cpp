...
bool aio_open_door(std::string channel_id, std::string in_out, std::string flag)
{
    ...
    unsigned char open_in[] = {0x14, 0x6b, 0x9d, 0x98, 0x40, 0x49, 0x50, 0x52, 0x52, 0x54, 0x01, 0x00, 0x01, 0x02, 0x25};
    unsigned char open_out[] ={0x14, 0x6b, 0x9d, 0x98, 0x40, 0x49, 0x50, 0x52, 0x52, 0x54, 0x01, 0x00, 0x01, 0x02, 0x25};
